...
class AgentConfig:
    ...
    knowledge_base_path: Path = Path("data/kb_raw")
    processed_output_path: Path = Path("data/kb_processed/kb.jsonl")
        ...
        if config_path.exists():
            ...
            return cls(
                ...
                processed_output_path=Path(
                    payload.get("processed_output_path", cls.processed_output_path)
                ),
        ...
        return json.dumps(
            {
                ...
                "processed_output_path": str(self.processed_output_path),
